...
<div class="mdui-card">
  ...
  <div class="mdui-card-actions">
    <a href="send.php?id='.$id.'" class="mdui-btn mdui-ripple">发送</a>
    <a href="receive.php?id='.$id.'" class="mdui-btn mdui-ripple">接收</a>
  </div>
</div><br/>';
}
}
...
<div class="mdui-card">
  ...
  <!-- 卡片的按钮 -->
  <div class="mdui-card-actions">
    <a href="newdevice.php" class="mdui-btn mdui-ripple">添加</a>
  </div>
</div><br/>';
}
?>
